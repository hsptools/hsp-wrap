#
# ICC 9.0 on 64-bit Linux for MIC target
...
NCBI_CFLAGS1 = -c -mmic
NCBI_LDFLAGS1 = -mmic -i-static -O3 -unroll -fno-builtin-memcpy -fno-builtin-memset
NCBI_OPTFLAG = -O3 -mmic -unroll -fno-builtin-memcpy -fno-builtin-memset
#
