...
NCBI_CC = icc -D_GCC_NEXT_LIMITS_H -D_GNU_SOURCE -msse -msse2
NCBI_CFLAGS1 = -c
#NCBI_LDFLAGS1 = -i-static -O0 -ggdb -unroll -fno-builtin-memcpy -fno-builtin-memset
#NCBI_OPTFLAG = -O0 -ggdb -unroll -fno-builtin-memcpy -fno-builtin-memset
NCBI_LDFLAGS1 = -i-static -g -O3
NCBI_OPTFLAG = -g -O3
#
...
NCBI_OTHERLIBS = -Wl,-Bdynamic -lm
NCBI_RANLIB = ranlib
# Used by makedis.csh
NCBI_MT_OTHERLIBS = -Wl,-Bdynamic -lpthread -Wl,-Bstatic 
