...
typedef void (*SuspectProductNameReplaceFunc) PROTO ((CharPtr PNTR, CharPtr, CharPtr));
...
static void SimpleReplaceFunc (CharPtr PNTR orig, CharPtr find, CharPtr replace)
{
  FindReplaceString (orig, find, replace, FALSE, TRUE);
}


static void ReplaceAtFront (CharPtr PNTR orig, CharPtr find, CharPtr replace)
{
...
static void UsePutative (CharPtr PNTR orig, CharPtr find, CharPtr replace)
{
  Int4 i;
  for (i = 0; s_putative_replacements[i] != NULL; i++) {
    ReplaceAtFront (orig, s_putative_replacements[i], "putative");
  }
}


static void HaemReplaceFunc (CharPtr PNTR orig, CharPtr find, CharPtr replace)
{
...
static SuspectProductNameData suspect_product_terms[] = {
  { "beginning with period, comma, or hyphen" , BeginsWithPunct, FALSE, NULL, NULL } ,
  { "binding" , EndsWithPattern, FALSE, NULL, NULL } ,
  { "like" , EndsWithPattern, FALSE, NULL, NULL } ,
  { "motif" , EndsWithPattern, FALSE, NULL, NULL } ,
  { "related" , EndsWithPattern, FALSE, NULL, NULL } ,
  { "fold" , EndsWithFold, FALSE, NULL, NULL } ,
  { "Arabidopsis" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Aspergillus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "B.subtilis" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Bacillus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Bacteroides" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Campylobacter" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Chlamydial" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Chlamydomonas" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Drosophila" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "E.coli" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Escherichia" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Helicobacter" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Includes:" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Jejuni" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Leishmania" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Marinococcus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Mus musculus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Mycobacterium" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Pestis" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Rhodobacter" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Salmonella" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Staphlococcal" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Staphlococcus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Staphylococcus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Streptococcus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Subtilis" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Tuberculosis" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Typhimurium" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "Yersinia" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "aminotransferasee" , ContainsWholeWord, TRUE, "aminotransferase", SimpleReplaceFunc } ,
  { "arginin " , ContainsWholeWord, TRUE, "arginine ", SimpleReplaceFunc } ,
  { "argininte" , ContainsWholeWord, TRUE, "arginine", SimpleReplaceFunc } ,
  { "aureus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "bioin" , ContainsWholeWord, TRUE, "biotin", SimpleReplaceFunc } ,
  { "biosythesis" , ContainsWholeWord, TRUE, "biosynthesis", SimpleReplaceFunc } ,
  { "cerevisiae" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "chelatin" , ContainsWholeWord, TRUE, "chelating", SimpleReplaceFunc } ,
  { "coli" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "contain" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "deydrogenase" , ContainsWholeWord, TRUE, "dehydrogenase", SimpleReplaceFunc } ,
  { "diacyglycerol" , ContainsWholeWord, TRUE, "diacylglycerol", SimpleReplaceFunc } ,
  { "domainl", ContainsWholeWord, TRUE, "domain", SimpleReplaceFunc } ,
  { "enterica" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "exporte" , ContainsWholeWord, TRUE, "exported", SimpleReplaceFunc } ,
  { "familie" , ContainsWholeWord, TRUE, "family", SimpleReplaceFunc } ,
  { "gene" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "genes" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "glycin" , ContainsWholeWord, TRUE, "glycine", SimpleReplaceFunc } ,
  { "glycosy" , ContainsWholeWord, TRUE, "glucosyl", SimpleReplaceFunc } ,
  { "halophilus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "hemaggltinin" , ContainsWholeWord, TRUE, "hemagglutinin", SimpleReplaceFunc } ,
  { "hexpeptide" , ContainsWholeWord, TRUE, "hexapeptide", SimpleReplaceFunc } ,
  { "histide" , ContainsWholeWord, TRUE, "histidine", SimpleReplaceFunc } ,
  { "homo" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "homocystein" , ContainsWholeWord, TRUE, "homocysteine", SimpleReplaceFunc } ,
  { "hyp domain protein" , IsSingleWord, TRUE, "hypothetical protein", SimpleReplaceFunc },
  { "hypot" , ContainsWholeWord, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothe" , ContainsWholeWord, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothet" , ContainsWholeWord, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothetic" , ContainsWholeWord, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothetica" , ContainsWholeWord, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothetical domain protein" , IsSingleWord, TRUE, "hypothetical protein", SimpleReplaceFunc },
  { "inactivated derivative" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "initation" , ContainsWholeWord, TRUE, "initiation", SimpleReplaceFunc } ,
  { "invertion" , ContainsWholeWord, TRUE, "inversion", SimpleReplaceFunc } ,
  { "isomaerase" , ContainsWholeWord, TRUE, "isomerase", SimpleReplaceFunc } ,
  { "mobilisation" , ContainsWholeWord, TRUE, "mobilization", SimpleReplaceFunc } ,
  { "mouse" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "mutatrotase" , ContainsWholeWord, TRUE, "mutarotase", SimpleReplaceFunc } ,
  { "ncharacterized" , ContainsWholeWord, TRUE, "uncharacterized", SimpleReplaceFunc } ,
  { "ndoribonuclease" , ContainsWholeWord, TRUE, "endoribonuclease", SimpleReplaceFunc } ,
  { "niger" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "ntegral " , ContainsWholeWord, TRUE, "integral ", SimpleReplaceFunc } ,
  { "obalt" , ContainsWholeWord, TRUE, "cobalt", SimpleReplaceFunc } ,
  { "odule" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "orf, hyp" , IsSingleWord, TRUE, "hypothetical protein", SimpleReplaceFunc },
  { "orf, hypothetical" , IsSingleWord, TRUE, "hypothetical protein", SimpleReplaceFunc },
  { "oxidoreductasee" , ContainsWholeWord, TRUE, "oxidoreductase", SimpleReplaceFunc } ,
  { "oxidoredutase" , ContainsWholeWord, TRUE, "oxidoreductase", SimpleReplaceFunc } ,
  { "periplamic" , ContainsWholeWord, TRUE, "periplasmic", SimpleReplaceFunc } ,
  { "periplasmc" , ContainsWholeWord, TRUE, "periplasmic", SimpleReplaceFunc } ,
  { "phosphatidyltransferse" , ContainsWholeWord, TRUE, "phosphatidyltransferase", SimpleReplaceFunc } ,
  { "phosphopantethiene" , ContainsWholeWord, TRUE, "phosphopantetheine", SimpleReplaceFunc } ,
  { "pombe" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "portein" , ContainsWholeWord, TRUE, "protein", SimpleReplaceFunc } ,
  { "protei" , ContainsWholeWord, TRUE, "protein", SimpleReplaceFunc } ,
  { "protwin" , ContainsWholeWord, TRUE, "protein", SimpleReplaceFunc } ,
  { "pseudo" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "pseudomonas" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "puter" , ContainsWholeWord, TRUE, "outer", SimpleReplaceFunc } ,
  { "pylori" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "rat" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "reductasee" , ContainsWholeWord, TRUE, "reductase", SimpleReplaceFunc } ,
  { "rsponse" , ContainsWholeWord, TRUE, "response", SimpleReplaceFunc } ,
  { "serovar" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "sigm" , ContainsWholeWord, TRUE, "sigma", NULL } ,
  { "sreptomyces" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "staphylococcal" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "start codon" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "streptococcal" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "streptomyces" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "subsp" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "tetracenpmycin" , ContainsWholeWord, TRUE, "tetracenomycin", SimpleReplaceFunc } ,
  { "thaliana" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "thiamin/thiamin" , ContainsWholeWord, TRUE, "thiamin/thiamine", SimpleReplaceFunc } ,
  { "thioderoxin" , ContainsWholeWord, TRUE, "thioredoxin", SimpleReplaceFunc } ,
  { "threonin" , ContainsWholeWord, TRUE, "threonine", SimpleReplaceFunc } ,
  { "transcrIptional" , ContainsWholeWordCaseSensitive, TRUE, "transcriptional", SimpleReplaceFunc } ,
  { "transemembrane" , ContainsWholeWord, TRUE, "transmembrane", SimpleReplaceFunc } ,
  { "transferasee" , ContainsWholeWord, TRUE, "transferase", SimpleReplaceFunc } ,
  { "transmebrane" , ContainsWholeWord, TRUE, "transmembrane", SimpleReplaceFunc } ,
  { "unkn", IsSingleWord, FALSE, "hypothetical protein", SimpleReplaceFunc },
  { "unnamed" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "utilisation" , ContainsWholeWord, TRUE, "utilization", SimpleReplaceFunc } ,
  { "xenopus" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "yeast" , ContainsWholeWord, FALSE, NULL, NULL } ,
  { "ypothetical" , ContainsWholeWord, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "ytochrome" , ContainsWholeWord, TRUE, "cytochrome", SimpleReplaceFunc } ,
  { "containing" , StartsWithPattern, FALSE, NULL, NULL } ,
  { "from" , StartsWithPattern, FALSE, NULL, NULL } ,
  { "CHC2 zinc finger" , IsSingleWord, FALSE, NULL, NULL } ,
  { "conserved hypothetical protein", IsSingleWord, TRUE, "hypothetical protein", SimpleReplaceFunc } ,
  { "SWIM zinc finger" , IsSingleWord, FALSE, NULL, NULL } ,
  { "probable protein" , IsSingleWord, FALSE, NULL, NULL } ,
  { "protein" , IsSingleWord, FALSE, NULL, NULL } ,
  { "sodium" , IsSingleWord, FALSE, NULL, NULL } ,
  { "IS" , PrefixPlusNumbersOnly, FALSE, NULL, NULL } ,
 ...
 FALSE, NULL, NULL } ,
  { "all capital letters" , AllCapitalLetters, FALSE, NULL, NULL } ,
  { "#" , NormalSearch, FALSE, NULL, NULL } ,
  { ". " , NormalSearch, FALSE, NULL, NULL } ,
  { "=" , NormalSearch, FALSE, NULL, NULL } ,
  { "?" , NormalSearch, FALSE, NULL, NULL } ,
  { "%" , NormalSearch, FALSE, NULL, NULL } ,
  { "Chloroplast" , NormalSearch, FALSE, NULL, NULL } ,
  { "ECOLI" , NormalSearch, FALSE, NULL, NULL } ,
  { "Fragment" , NormalSearch, FALSE, NULL, NULL } ,
  { "Frameshift" , NormalSearch, FALSE, NULL, NULL } ,
  { "Homolog" , NormalSearch, FALSE, NULL, NULL } ,
  { "Homologue" , NormalSearch, FALSE, NULL, NULL } ,
  { "Intein" , NormalSearch, FALSE, NULL, NULL } ,
  { "Intiation" , NormalSearch, TRUE, "initiation", SimpleReplaceFunc } ,
  { "K potassium" , NormalSearch, FALSE, NULL, NULL } ,
  { "K+ potassium" , NormalSearch, FALSE, NULL, NULL } ,
  { "Mitochondrial" , NormalSearch, FALSE, NULL, NULL } ,
  { "No definition line found" , NormalSearch, FALSE, NULL, NULL } ,
  { "Plasmodium" , NormalSearch, FALSE, NULL, NULL } ,
  { "Portein" , NormalSearch, FALSE, NULL, NULL } ,
  { "Related to" , NormalSearch, FALSE, NULL, NULL } ,
  { "Similar to" , NormalSearch, FALSE, NULL, NULL } ,
  { "Transemembrane" , NormalSearch, FALSE, NULL, NULL } ,
  { "Transmebrane" , NormalSearch, FALSE, NULL, NULL } ,
  { "\\-PA" , NormalSearch, FALSE, NULL, NULL } ,
  { "accessroy" , NormalSearch, TRUE, "accessory", SimpleReplaceFunc } ,
  { "aceytltranferase" , NormalSearch, TRUE, "acetyltransferase", SimpleReplaceFunc } ,
  { "active site" , NormalSearch, FALSE, NULL, NULL } ,
  { "adenylattransferase" , NormalSearch, TRUE, "adenylate transferase", SimpleReplaceFunc } ,
  { "adenylytransferase" , NormalSearch, TRUE, "adenylyltransferase", SimpleReplaceFunc } ,
  { "alternate protein name" , NormalSearch, FALSE, NULL, NULL } ,
  { "aluminium" , NormalSearch, TRUE, "aluminum", SimpleReplaceFunc } ,
  { "aminopetidase" , NormalSearch, TRUE, "aminopeptidase", SimpleReplaceFunc } ,
  { "aparaginase" , NormalSearch, TRUE, "asparaginase", SimpleReplaceFunc } ,
  { "asparate" , NormalSearch, TRUE, "aspartate", SimpleReplaceFunc } ,
  { "authentic point mutation" , NormalSearch, FALSE, NULL, NULL } ,
  { "bifunctional protein" , NormalSearch, FALSE, NULL, NULL } ,
  { "bifunctionnal" , NormalSearch, TRUE, "bifunctional", SimpleReplaceFunc } ,
  { "bigenesis" , NormalSearch, TRUE, "biogenesis", SimpleReplaceFunc } ,
  { "biosyntesis" , NormalSearch, TRUE, "biosynthesis", SimpleReplaceFunc } ,
  { "bnding" , NormalSearch, TRUE, "binding", SimpleReplaceFunc } ,
  { "bos taurus" , NormalSearch, FALSE, NULL, NULL } ,
  { "carboxilic" , NormalSearch, TRUE, "carboxylic", SimpleReplaceFunc } ,
  { "cell divisionFtsK/SpoIIIE" , NormalSearch, FALSE, NULL, NULL } ,
  { "characterisation" , NormalSearch, TRUE, "characterization", SimpleReplaceFunc } ,
  { "coantaining" , NormalSearch, TRUE, "containing", SimpleReplaceFunc } ,
  { "coenzye" , NormalSearch, TRUE, "coenzyme", SimpleReplaceFunc } ,
  { "componenet" , NormalSearch, TRUE, "component", SimpleReplaceFunc } ,
  { "componnent" , NormalSearch, TRUE, "component", SimpleReplaceFunc } ,
  { "consevered" , NormalSearch, TRUE, "conserved", SimpleReplaceFunc } ,
  { "containg" , NormalSearch, TRUE, "containing", SimpleReplaceFunc } ,
  { "cotaining" , NormalSearch, TRUE, "containing", SimpleReplaceFunc } ,
  { "degration" , NormalSearch, TRUE, "degradation", SimpleReplaceFunc } ,
  { "deletion" , NormalSearch, FALSE, NULL, NULL } ,
  { "dependant" , NormalSearch, TRUE, "dependent", SimpleReplaceFunc } ,
  { "dimerisation" , NormalSearch, TRUE, "dimerization", SimpleReplaceFunc } ,
  { "dimerising" , NormalSearch, TRUE, "dimerizing", SimpleReplaceFunc } ,
  { "dioxyenase" , NormalSearch, TRUE, "dioxygenase", SimpleReplaceFunc } ,
  { "disulphide" , NormalSearch, TRUE, "disulfide", SimpleReplaceFunc } ,
  { "divison" , NormalSearch, TRUE, "division", SimpleReplaceFunc } ,
  { "domain domain" , NormalSearch, FALSE, NULL, NULL } ,
  { "domain protein domain protein" , NormalSearch, FALSE, NULL, NULL } ,
  { "domian" , NormalSearch, TRUE, "domain", SimpleReplaceFunc } ,
  { "dyhydrogenase" , NormalSearch, FALSE, NULL, NULL } ,
  { "dyhydrogenase" , NormalSearch, TRUE, "dehydrogenase", SimpleReplaceFunc } ,
  { "enentioselective" , NormalSearch, TRUE, "enantioselective", SimpleReplaceFunc } ,
  { "facotr" , NormalSearch, TRUE, "factor", SimpleReplaceFunc } ,
  { "family family" , NormalSearch, TRUE, "family", SimpleReplaceFunc } ,
  { "flageller" , NormalSearch, TRUE, "flagellar", SimpleReplaceFunc } ,
  { "frame shift" , NormalSearch, FALSE, NULL, NULL } ,
  { "gIycerol" , NormalSearch, TRUE, "glycerol", SimpleReplaceFunc } ,
  { "glcosyl" , NormalSearch, TRUE, "glycosyl", SimpleReplaceFunc } ,
  { "glucosainyl" , NormalSearch, TRUE, "glucosaminyl", SimpleReplaceFunc } ,
  { "glutaminne" , NormalSearch, TRUE, "glutamine", SimpleReplaceFunc } ,
  { "golgi" , NormalSearch, FALSE, NULL, NULL } ,
  { "haem" , NormalSearch, TRUE, "heme", HaemReplaceFunc } ,
  { "haemagglutination" , NormalSearch, TRUE, "hemagglutination", SimpleReplaceFunc } ,
  { "heam" , NormalSearch, TRUE, "heme", HaemReplaceFunc } ,
  { "hemelysin" , NormalSearch, TRUE, "hemolysin", SimpleReplaceFunc } ,
  { "hemoglobine" , NormalSearch, TRUE, "hemoglobin", SimpleReplaceFunc } ,
  { "hexapaptide" , NormalSearch, TRUE, "hexapeptide", SimpleReplaceFunc } ,
  { "highly conserved" , NormalSearch, FALSE, NULL, NULL } ,
  { "histadine" , NormalSearch, TRUE, "histidine", SimpleReplaceFunc } ,
  { "homeserine" , NormalSearch, TRUE, "homoserine", SimpleReplaceFunc } ,
  { "homo sapiens" , NormalSearch, FALSE, NULL, NULL } ,
  { "hpothetical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "human" , NormalSearch, FALSE, NULL, NULL } ,
  { "hyphotetical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hyphotheical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypotehtical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypotethical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypotetical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypotheical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypotheitcal" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothetcial" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothteical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypothtical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hypthetical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "hyptothetical" , NormalSearch, TRUE, "hypothetical", SimpleReplaceFunc } ,
  { "inductible" , NormalSearch, TRUE, "inducible", SimpleReplaceFunc } ,
  { "interrupt" , NormalSearch, FALSE, NULL, NULL } ,
  { "isomerse" , NormalSearch, TRUE, "isomerase", SimpleReplaceFunc } ,
  { "majour" , NormalSearch, TRUE, "major", SimpleReplaceFunc } ,
  { "mambrane" , NormalSearch, TRUE, "membrane", SimpleReplaceFunc } ,
  { "meausure" , NormalSearch, TRUE, "measure", SimpleReplaceFunc } ,
  { "membranne" , NormalSearch, TRUE, "membrane", SimpleReplaceFunc } ,
  { "methlytransferase" , NormalSearch, TRUE, "methyltransferase", SimpleReplaceFunc } ,
  { "metylase" , NormalSearch, TRUE, "methylase", SimpleReplaceFunc } ,
  { "molibdenum" , NormalSearch, TRUE, "molybdenum", SimpleReplaceFunc } ,
  { "molybopterin" , NormalSearch, TRUE, "molybdopterin", SimpleReplaceFunc } ,
  { "molydopterin" , NormalSearch, TRUE, "molybdopterin", SimpleReplaceFunc } ,
  { "monooxigenase" , NormalSearch, TRUE, "monooxygenase", SimpleReplaceFunc } ,
  { "monoxyde" , NormalSearch, TRUE, "monoxide", SimpleReplaceFunc } ,
  { "monoxygenase" , NormalSearch, TRUE, "monooxygenase", SimpleReplaceFunc } ,
  { "mulitdrug" , NormalSearch, TRUE, "multidrug", SimpleReplaceFunc } ,
  { "narrowly conserved" , NormalSearch, FALSE, NULL, NULL } ,
  { "nickle" , NormalSearch, TRUE, "nickel", SimpleReplaceFunc } ,
  { "novel protein" , NormalSearch, FALSE, NULL, NULL } ,
  { "nucelar" , NormalSearch, TRUE, "nuclear", SimpleReplaceFunc } ,
  { "nucleotydyl" , NormalSearch, TRUE, "nucleotidyl", SimpleReplaceFunc } ,
  { "nulcear" , NormalSearch, TRUE, "nuclear", SimpleReplaceFunc } ,
  { "open reading frame" , NormalSearch, FALSE, NULL, NULL } ,
  { "or related" , NormalSearch, FALSE, NULL, NULL } ,
  { "orphan protein" , NormalSearch, FALSE, NULL, NULL } ,
  { "ortholog" , NormalSearch, FALSE, NULL, NULL } ,
  { "orthologue" , NormalSearch, FALSE, NULL, NULL } ,
  { "outers" , NormalSearch, TRUE, "outer", SimpleReplaceFunc } ,
  { "oxidoreducatse" , NormalSearch, TRUE, "oxidoreductase", SimpleReplaceFunc } ,
  { "oxidoreductasse" , NormalSearch, TRUE, "oxidoreductase", SimpleReplaceFunc } ,
  { "oxidoreduxtase" , NormalSearch, TRUE, "oxidoreductase", SimpleReplaceFunc } ,
  { "oxydase" , NormalSearch, TRUE, "oxidase", SimpleReplaceFunc } ,
  { "paralog" , NormalSearch, FALSE, NULL, NULL } ,
  { "paralogue" , NormalSearch, FALSE, NULL, NULL } ,
  { "partial" , NormalSearch, FALSE, NULL, NULL } ,
  { "peptidodoglycan" , NormalSearch, TRUE, "peptidoglycan", SimpleReplaceFunc } ,
  { "periplsmic" , NormalSearch, TRUE, "periplasmic", SimpleReplaceFunc } ,
  { "phophate" , NormalSearch, TRUE, "phosphate", SimpleReplaceFunc } ,
  { "phopho" , NormalSearch, TRUE, "phospho", SimpleReplaceFunc } ,
  { "phophoserine" , NormalSearch, TRUE, "phosphoserine", SimpleReplaceFunc } ,
  { "phoshate" , NormalSearch, TRUE, "phosphate", SimpleReplaceFunc } ,
  { "phosphatransferase" , NormalSearch, TRUE, "phosphotransferase", SimpleReplaceFunc } ,
  { "phosphotase" , NormalSearch, TRUE, "phosphatase", SimpleReplaceFunc } ,
  { "posible" , NormalSearch, TRUE, "possible", SimpleReplaceFunc } ,
  { "presursor" , NormalSearch, TRUE, "precursor", SimpleReplaceFunc } ,
  { "probable putative" , NormalSearch, FALSE, NULL, NULL } ,
  { "proein" , NormalSearch, TRUE, "protein", SimpleReplaceFunc } ,
  { "prortein" , NormalSearch, TRUE, "protein", SimpleReplaceFunc } ,
  { "proteine" , NormalSearch, TRUE, "protein", SimpleReplaceFunc } ,
  { "proteinn" , NormalSearch, TRUE, "protein", SimpleReplaceFunc } ,
  { "protien" , NormalSearch, TRUE, "protein", SimpleReplaceFunc } ,
  { "protrein" , NormalSearch, TRUE, "protein", SimpleReplaceFunc } ,
  { "prptein" , NormalSearch, TRUE, "protein", SimpleReplaceFunc } ,
  { "pseudogene" , NormalSearch, FALSE, NULL, NULL } ,
  { "puatative" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "puative" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putaitive" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putaitve" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putaive" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putataive" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putatitve" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putative orphan protein" , NormalSearch, FALSE, NULL, NULL } ,
  { "putative probable" , NormalSearch, FALSE, NULL, NULL } ,
  { "putative putative" , NormalSearch, FALSE, NULL, NULL } ,
  { "putative, putative" , NormalSearch, FALSE, NULL, NULL } ,
  { "putatuve" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putatve" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putatvie" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putayive" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "putitive" , NormalSearch, TRUE, "putative", SimpleReplaceFunc } ,
  { "qlcohol" , NormalSearch, TRUE, "alcohol", SimpleReplaceFunc } ,
  { "recognised" , NormalSearch, TRUE, "recognized", SimpleReplaceFunc } ,
  { "regulatot" , NormalSearch, TRUE, "regulator", SimpleReplaceFunc } ,
  { "reponse" , NormalSearch, TRUE, "response", SimpleReplaceFunc } ,
  { "resistence" , NormalSearch, TRUE, "resistance", SimpleReplaceFunc } ,
  { "ribosimal" , NormalSearch, TRUE, "ribosomal", SimpleReplaceFunc } ,
  { "ribosoml" , NormalSearch, TRUE, "ribosomal", SimpleReplaceFunc } ,
  { "sapiens" , NormalSearch, FALSE, NULL, NULL } ,
  { "serinr" , NormalSearch, TRUE, "serine", SimpleReplaceFunc } ,
  { "signalling" , NormalSearch, TRUE, "signaling", SimpleReplaceFunc } ,
  { "similar" , NormalSearch, FALSE, NULL, NULL } ,
  { "simmilar" , NormalSearch, FALSE, NULL, NULL } ,
  { "specfic" , NormalSearch, TRUE, "specific", SimpleReplaceFunc } ,
  { "sphaeroides" , NormalSearch, FALSE, NULL, NULL } ,
  { "spscific" , NormalSearch, TRUE, "specific", SimpleReplaceFunc } ,
  { "stabilisation" , NormalSearch, TRUE, "stabilization", SimpleReplaceFunc } ,
  { "subnit" , NormalSearch, TRUE, "subunit", SimpleReplaceFunc } ,
  { "suger" , NormalSearch, TRUE, "sugar", SimpleReplaceFunc } ,
  { "sulpho" , NormalSearch, FALSE, NULL, NULL } ,
  { "sulphur" , NormalSearch, TRUE, "sulfur", SimpleReplaceFunc } ,
  { "systhesis" , NormalSearch, TRUE, "synthesis", SimpleReplaceFunc } ,
  { "sythase" , NormalSearch, TRUE, "synthase", SimpleReplaceFunc } ,
  { "thiredoxin" , NormalSearch, TRUE, "thioredoxin", SimpleReplaceFunc } ,
  { "trancsriptional" , NormalSearch, TRUE, "transcription", SimpleReplaceFunc } ,
  { "tranferase" , NormalSearch, TRUE, "transferase", SimpleReplaceFunc } ,
  { "tranporter" , NormalSearch, TRUE, "transporter", SimpleReplaceFunc } ,
  { "transcirbed" , NormalSearch, TRUE, "transcribed", SimpleReplaceFunc } ,
  { "transcriptonal" , NormalSearch, TRUE, "transcriptional", SimpleReplaceFunc } ,
  { "transcritional" , NormalSearch, TRUE, "transcriptional", SimpleReplaceFunc } ,
  { "transebrane" , NormalSearch, TRUE, "transmembrane", SimpleReplaceFunc } ,
  { "transglycolase" , NormalSearch, TRUE, "transglycosylase", SimpleReplaceFunc } ,
  { "transorter" , NormalSearch, TRUE, "transporter", SimpleReplaceFunc } ,
  { "transpoase" , NormalSearch, TRUE, "transposase", SimpleReplaceFunc } ,
  { "transportor" , NormalSearch, TRUE, "transporter", SimpleReplaceFunc } ,
  { "transproter" , NormalSearch, TRUE, "transporter", SimpleReplaceFunc } ,
  { "transulfuration" , NormalSearch, TRUE, "transsulfuration", SimpleReplaceFunc } ,
  { "trnasporter" , NormalSearch, TRUE, "transporter", SimpleReplaceFunc } ,
  { "truncat" , NormalSearch, FALSE, NULL, NULL } ,
  { "ttg start" , NormalSearch, FALSE, NULL, NULL } ,
  { "tumour" , NormalSearch, TRUE, "tumor", SimpleReplaceFunc } ,
  { "typr" , NormalSearch, TRUE, "type", SimpleReplaceFunc } ,
  { "uncharacterised" , NormalSearch, FALSE, NULL, NULL } ,
  { "uncharaterized" , NormalSearch, FALSE, NULL, NULL } ,
  { "undecapaprenyl" , NormalSearch, TRUE, "undecaprenyl", SimpleReplaceFunc } ,
  { "unkown" , NormalSearch, FALSE, NULL, NULL } ,
  { "utilising" , NormalSearch, TRUE, "utilizing", SimpleReplaceFunc } ,
  { "weakly conserved" , NormalSearch, FALSE, NULL, NULL } ,
  { "widely conserved" , NormalSearch, FALSE, NULL, NULL } ,
  { "|" , NormalSearch, FALSE, NULL, NULL } ,
  { "C term" , ProductContainsTerm, FALSE, NULL, NULL } ,
  { "C-term" , ProductContainsTerm, FALSE, NULL, NULL } ,
  { "N term" , ProductContainsTerm, FALSE, NULL, NULL } ,
  { "N-term" , ProductContainsTerm, FALSE, NULL, NULL } ,
  { "Two or more sets of brackets or parentheseis" , ContainsTwoSetsOfBracketsOrParentheses, FALSE, NULL, NULL } ,
  { "unknown" , ContainsUnknownName, FALSE, NULL, NULL } ,
  { "double space" , ContainsDoubleSpace, FALSE, NULL, NULL } ,
  { "COG" , ContainsWholeWordCaseSensitive, FALSE, NULL, NULL } ,
  { "DUF" , ContainsWholeWordCaseSensitive, FALSE, NULL, NULL } ,
  { "EST" , ContainsWholeWordCaseSensitive, FALSE, NULL, NULL } ,
  { "FOG" , ContainsWholeWordCaseSensitive, FALSE, NULL, NULL } ,
  { "UPF" , ContainsWholeWordCaseSensitive, FALSE, NULL, NULL } ,
  { "_" , ContainsUnderscore, FALSE, NULL, NULL } ,
  { "ending with period, comma, hyphen, underscore, colon, or forward slash" , EndsWithPunct, FALSE, NULL, NULL } ,
  { "Alanine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Arginine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Asparagine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Aspartic acid" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Cysteine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "DNA" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Glutamic acid" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Glutamine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Glycine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Histidine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Isoleucine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Leucine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Lysine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Methionine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "NAD" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "ORF" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "PASTA" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "PTS system" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Phenylalanine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Proline" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "RNA" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Serine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Threonine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Tryptophan" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Tyrosine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "Valine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "adenine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "amino acid" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "barrel" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "carbon" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "citrate" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "conserved hypothetical" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "conserved" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "cytosine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "domain family" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "domain protein" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "domain" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "factor" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "family protein" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "finger" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "ggdef" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "guanine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "helium" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "helix" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "helix-turn-helix" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "hydrogen" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "hypothetical ORF" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "hypothetical" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "insertion sequence" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "iron" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "mRNA" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "membrane" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "ncRNA" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "nitrogen" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "oxygen" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "p-loop" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "peptide" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "phage" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "plasmid" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "precursor" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "probable" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "protein containing" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "protein of unknown function" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "protein-containing" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "purine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "putative conserved hypothetical" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "putative hypothetical" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "putative protein" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "putative signal peptide" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "putative" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "rRNA" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "repeat" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "secreted" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "signal peptide" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "signal" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "subunit" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "tRNA" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "thymine" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "transport-associated" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "transposase of" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "transposon" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "uracil" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "zinc finger" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "zinc" , IsSingleWordOrWeaselPlusSingleWord, FALSE, NULL, NULL } ,
  { "may contain a plural" , MayContainPlural, FALSE, NULL, NULL } ,
  { "unbalanced brackets or parentheses" , ContainsUnbalancedParentheses, FALSE, NULL, NULL } ,
  { "long product name that may contain descriptive information more appropriate in a note", IsTooLong, FALSE, NULL, NULL } ,
  { "Product name begins with possible, potential, predicted or probable.  Please use putative.", StartsWithPutativeReplacement, TRUE, "putative", UsePutative }
};
...
static void FixSuspectProductNameTyposInOneFeature (SeqFeatPtr cds, LogInfoPtr lip)
{
  Int4            k;
  ProtRefPtr      prp;
  ValNodePtr      vnp;
  ...
  {    
    for (vnp = prp->name; vnp != NULL; vnp = vnp->next) 
    {
      if (suspect_product_terms[k].is_typo
        ...
        && (suspect_product_terms[k].search_func) (suspect_product_terms[k].pattern, vnp->data.ptrvalue)) 
      {
        if (lip != NULL && lip->fp != NULL) {
          ...
          (suspect_product_terms[k].replace_func)(&tmp, suspect_product_terms[k].pattern, suspect_product_terms[k].replace_phrase);
          if (StringCmp (tmp, vnp->data.ptrvalue) != 0) {
            MemSet (&vn, 0, sizeof (ValNode));
            vn.choice = OBJ_SEQFEAT;
            vn.data.ptrvalue = cds;
            desc = GetDiscrepancyItemText (&vn);
            fprintf (lip->fp, "Changed '%s' to '%s' for %s\n", (CharPtr) vnp->data.ptrvalue, tmp, desc);
...
NLM_EXTERN void FixSuspectProductNameTypos (ValNodePtr item_list, Pointer data, LogInfoPtr lip)
{
  ValNodePtr vnp;

  for (vnp = item_list; vnp != NULL; vnp = vnp->next) {
    if (vnp->choice == OBJ_SEQFEAT) {
      FixSuspectProductNameTyposInOneFeature ((SeqFeatPtr) vnp->data.ptrvalue, lip);
    }
  }
}
...
extern void FindSuspectProductNames (ValNodePtr PNTR discrepancy_list, ValNodePtr sep_list)
{
  ...
  ValNodePtr         subcategories = NULL, typos = NULL;
  ...
  {
    if (typos != NULL) {
      tdip = SuspectPhraseEx (DISC_SUSPECT_PRODUCT_NAME, "typo", FALSE, "product_name", ItemListFromSubcategories (typos));
      tdip->subcategories = typos;
      if (subcategories != NULL) {
    ...
    if (subcategories == NULL) {
      ValNodeAddPointer (discrepancy_list, 0, tdip);
    } else {
...
static void FindBacteriamRNA (ValNodePtr PNTR discrepancy_list, ValNodePtr sep_list)
{
  ...
  seq->feature = Macro_feature_type_mRNA;
...
static DiscrepancyInfoData discrepancy_info_list[] = 
{
  ...
  { "Suspect Product Name", "SUSPECT_PRODUCT_NAMES", FindSuspectProductNames, FixSuspectProductNameTypos },
...
static void FillInMissingTraces (ValNodePtr trace_check_list)
{
  ...
  if (fp == NULL) {
    ...
    /* launch script */
#ifdef OS_UNIX
    sprintf (cmmd, "csh %s -i %s -o %s", tracefetchcmd, path_in, path_out);
    system (cmmd);
#endif
#ifdef OS_MSWIN
      ...
      if (new_country == NULL) {
        ...
        cp = StringChr (new_country, ':');
          ...
          if (*(cp + 1) != 0 && !isspace (*(cp + 1))) {
            ...
            StringNCpy (tmp, new_country, cp - new_country + 1);
            StringCat (tmp, " ");
            StringCat (tmp, cp + 1);
