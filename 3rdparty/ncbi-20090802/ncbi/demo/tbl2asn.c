...
#define J_argDelayGenProdSet  10
#define F_argFeatIdLinks      11
#define A_argAccession        12
#define C_argCenter           13
#define n_argOrgName          14
#define j_argSrcQuals         15
#define y_argComment          16
#define Y_argCommentFile      17
#define D_argDescrsFile       18
#define f_argTableFile        19
#define k_argCdsFlags         20
#define V_argVerify           21
#define v_argValidate         22
#define b_argGenBank          23
#define q_argFileID           24
#define u_argUndoGPS          25
#define h_argGnlToNote        26
#define G_argGapFields        27
#define R_argRemote           28
#define S_argSmartFeats       29
#define Q_argSmartTitle       30
#define U_argUnnecXref        31
#define L_argLocalID          32
#define T_argTaxLookup        33
#define P_argPubLookup        34
#define W_argLogProgress      35
#define K_argBioseqSet        36
#define H_argHoldUntilPub     37
#define Z_argDiscRepFile      38
#define c_argCleanupOptions   39
#define z_argCleanupLogFile   40
#define X_argExtraFlags       41
#define N_argProjectVersion   42
#define w_argStrucCommFile    43
...
Args myargs [] = {
  ...
  {"Extra Flags (combine any of the following letters)\n"
   ...
   "      M Adjust mRNA 3' end when adjusting coding region 3' end for stop codons",  NULL, NULL, NULL,
    TRUE, 'X', ARG_STRING, 0.0, 0, NULL},
...

{
  ...
  if (! GetArgs (app, sizeof (myargs) / sizeof (Args), myargs)) {
    Message (MSG_POST, "Incorrect format for arguments");
    return 0;
  }
